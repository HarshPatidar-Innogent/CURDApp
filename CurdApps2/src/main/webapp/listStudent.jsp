...
<div class="container mt-5">
    <div class="center mb-4">
        <p class="mb-0">For insert, update, and delete operations by <b>Student ID</b>: click on the following links:</p>
        ...
        <tbody>
            ...
            %>
                        <tr>
                            ...
                            <td><a href="UpdateStudent?id=<%=rs.getInt(1) %>" class="btn btn-primary">Edit</a></td>
                            <td><a href="DeleteStudent?id=<%=rs.getInt(1) %>" class="btn btn-danger">Delete</a></td>
                        </tr>
            <% 
                    }
                } catch (Exception e) {
